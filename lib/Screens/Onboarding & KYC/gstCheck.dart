...
class GstCheck extends StatefulWidget {
  const GstCheck({Key? key}) : super(key: key);

  @override
  State<GstCheck> createState() => _GstCheckState();
}

class _GstCheckState extends State<GstCheck> {
  @override
      ...
      bottomNavigationBar: ContinueBtnSimple(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => AadhaarFrontSide()));
          }),
    );
  }
}
