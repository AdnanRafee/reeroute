...
import 'package:reeroute/Screens/profile/profileUpdatedSuccessfully.dart';

import '../../common/appBarReeroute.dart';

class UpdateEditProfile extends StatefulWidget {
  const UpdateEditProfile({Key? key}) : super(key: key);

  @override
  State<UpdateEditProfile> createState() =>
      _OtpScreenState(); //state name difference
}

class _OtpScreenState extends State<UpdateEditProfile> {
  @override
